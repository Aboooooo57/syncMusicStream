...
from settings import SOCKET_SERVER, SOCKET_SERVER_PORT, HTTP_SERVER, HTTP_SERVER_PORT, MINIO_BUCKET_NAME
...
def main():
    ...
    objs = MinioClient.get_client().list_objects(MINIO_BUCKET_NAME)
    for obj in objs:
